...
#cmt_local_tagfile_check_install_joboptions = $(DispDilepAthena_tag)_check_install_joboptions.make
cmt_local_tagfile_check_install_joboptions = $(bin)$(DispDilepAthena_tag)_check_install_joboptions.make
...
#cmt_local_tagfile_check_install_joboptions = $(DispDilepAthena_tag).make
cmt_local_tagfile_check_install_joboptions = $(bin)$(DispDilepAthena_tag).make
...
#cmt_final_setup_check_install_joboptions = $(bin)DispDilepAthena_check_install_joboptionssetup.make
...
#cmt_final_setup_check_install_joboptions = $(bin)DispDilepAthenasetup.make
cmt_local_check_install_joboptions_makefile = $(bin)check_install_joboptions.make
...
$(check_install_joboptionsactionstamp) ::
	$(silent) /cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc49-opt/20.7.9/AtlasCore/20.7.9/External/ExternalPolicy/cmt/atlas_check_installations.sh -files=' -s=../share *.py ' -installdir=/n/atlas05/userdata/sche/testalg/InstallArea/jobOptions/DispDilepAthena -level=
