#ifndef DISPDILEPATHENA_SMBKGEST_H
#define DISPDILEPATHENA_SMBKGEST_H 1
...
class SMBkgEst: public ::AthAnalysisAlgorithm { 
    public: 
        SMBkgEst( const std::string& name, ISvcLocator* pSvcLocator );
        virtual ~SMBkgEst(); 
...
#endif //> !DISPDILEPATHENA_SMBKGEST_H
