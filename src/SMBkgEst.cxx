...
SMBkgEst::SMBkgEst( const std::string& name, ISvcLocator* pSvcLocator ) :
...
StatusCode SMBkgEst::initialize() {
...
StatusCode SMBkgEst::beginInputFile() { 
    return StatusCode::SUCCESS;
}


bool SMBkgEst::PassCosmicVeto_R_CR(xAOD::TrackParticle& tr0, xAOD::TrackParticle& tr1){
...
bool SMBkgEst::PassCosmicVeto_DeltaR(xAOD::TrackParticle& tr0, xAOD::TrackParticle& tr1){
...
const xAOD::TruthVertex* SMBkgEst::getClosestTruthVertex(const xAOD::Vertex *rv){
...
void SMBkgEst::PerformFit(xAOD::TrackParticle& tr1, xAOD::TrackParticle& tr2, const Amg::Vector3D& pv,std::string channel)
{
...
void SMBkgEst::PerformFit_flip(xAOD::TrackParticle& tr1, xAOD::TrackParticle& tr2, const Amg::Vector3D& pv,std::string channel)
{
    // create truth vertex for matching
    const xAOD::TruthVertex *tru_matched = nullptr;
