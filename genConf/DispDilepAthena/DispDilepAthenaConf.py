#Sat Feb  3 17:43:07 2018"""Automatically generated. DO NOT EDIT please"""
...
class FlipBkgEst( ConfigurableAlgorithm ) :
  __slots__ = { 
    ...
    'TrackToVertexTool' : PublicToolHandle('Reco::TrackToVertex'), # GaudiHandle
    'TrkVKalVrtFitter' : PublicToolHandle('Trk::TrkVKalVrtFitter/VxFitter'), # GaudiHandle
  }
  _propertyDocDct = { 
    'HistTitlePrefix' : """ The prefix for the histogram THx title """,
    'DetStore' : """ Handle to a StoreGateSvc/DetectorStore instance: it will be used to retrieve data during the course of the job """,
...
class VertexingSystematics( ConfigurableAlgorithm ) :
  __slots__ = { 
    'OutputLevel' : 0, # int
    'Enable' : True, # bool
    'ErrorMax' : 1, # int
    ...
    'OverlapRemoval' : PublicToolHandle('DDL::OverlapRemoval/OverlapRemoval'), # GaudiHandle
    'Vertexer' : PublicToolHandle('DDL::DispVertexer/DispVertexer'), # GaudiHandle
    'VrtFitter' : PublicToolHandle('Trk::TrkVKalVrtFitter'), # GaudiHandle
  }
  _propertyDocDct = { 
    'HistTitlePrefix' : """ The prefix for the histogram THx title """,
    'DetStore' : """ Handle to a StoreGateSvc/DetectorStore instance: it will be used to retrieve data during the course of the job """,
  ...
  def __init__(self, name = Configurable.DefaultName, **kwargs):
      super(VertexingSystematics, self).__init__(name)
      for n,v in kwargs.items():
         setattr(self, n, v)
  def getDlls( self ):
      return 'DispDilepAthena'
  def getType( self ):
      return 'VertexingSystematics'
  pass # class VertexingSystematics
