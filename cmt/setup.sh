...
${CMTROOT}/${CMTBIN}/cmt.exe setup -sh -pack=DispDilepAthena -version=DispDilepAthena-00-00-00 -path=/n/atlas05/userdata/sche/AtlasDerivation.20.7.9.3.DispDilepAthena.new  -no_cleanup $* >${cmtDispDilepAthenatempfile}
if test $? != 0 ; then
  echo >&2 "${CMTROOT}/${CMTBIN}/cmt.exe setup -sh -pack=DispDilepAthena -version=DispDilepAthena-00-00-00 -path=/n/atlas05/userdata/sche/AtlasDerivation.20.7.9.3.DispDilepAthena.new  -no_cleanup $* >${cmtDispDilepAthenatempfile}"
  cmtsetupstatus=2
